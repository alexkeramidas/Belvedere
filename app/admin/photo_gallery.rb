ActiveAdmin.register PhotoGallery, :as => 'Galleries' do
    ...
    controller do
        def permitted_params
            params.permit galleries: [:title, :description, :visible, :article_type => 3,  photos_attributes: [:id, :article_id, :description, :image, :image_file_name, :image_content_type, :image_file_size, :image_updated_at, :_destroy]]
        end
